...
public class Seed {
    ...
    void onStart(@Observes StartupEvent ev) {
        ...
        List<TipoAtividade> tipos = List.of(
                ...
                new TipoAtividade("Projeto de Extensão", "Projetos voltados à comunidade", 30.0),
                new TipoAtividade("Publicação Científica", "Artigos publicados", 30.0),
                new TipoAtividade("Palestra/Workshop", "Participação em palestras", 15.0),
                new TipoAtividade("Iniciação Científica", "Programa de IC", 30.0),
                ...
                new TipoAtividade("Intercâmbio Acadêmico", "Experiência internacional", 30.0));
